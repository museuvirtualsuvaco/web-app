...
import CardsAxilas from "./cards/CriarCardsAxilas";
import { cardsData } from "../../constants/criarAxilas/constantsAxilas.data.js";
      ...
      <div className={styles.container}>
        <div className={styles.cabecalho}>
          ...
          <section>
            <p className={styles.sectionTexts}>
              Fundada em 2008, a Divinas Axilas é uma ONG criada pelos
              integrantes do Suvaco do Cristo com o objetivo de capacitar, gerar
              renda e preservar a cultura popular. Utilizando como atividades o
              fornecimento de cursos gratuitos semestrais de corte, modelagem e
              costura e oficinas para mulheres e homens no qual eram
              confeccionados fantasias, adereços, estandartes de carnaval e
              customização de camisetas e de carnaval durante todo o ano.
            </p>

            <p className={styles.sectionTexts}>
              As integrantes eram inicialmente residentes da comunidade do Santa
              Marta, sendo aberto posteriormente para todas as comunidades e
              recebiam da ONG kits de material gratuitamente durante o curso.
            </p>

            <p className={styles.sectionTexts}>
              A Divinas já recebeu prêmios como: o Economia Criativa (parte do
              programa Fomento a Iniciativas Empreendedoras e Inovadoras do
              Ministério da Cultura), na categoria “Novos Modelos de
              Empreendimentos e Negócios Criativos” e o Prêmio Fantasia do
              Serpentina de Ouro 2012.
            </p>
        ...
        <div className={styles.areaVerde}>
          <div className={styles.cardContainer}>
            <CardsAxilas cardsData={cardsData} />
          </div>
