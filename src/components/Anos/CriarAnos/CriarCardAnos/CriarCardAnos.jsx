...
import styles from "./criarCardsAnos.module.css"

export default function CriarCardsAnos({ ano, cardsData }) {
    return (
        <>
                        ...
                        <div className={styles.cardInfo} style={{ background: gradient }}>
                            <div className={styles.textsFlex}>
                                ...
                                <button className={styles.button}>
                                    Clique para ver mais! <i className="ri-arrow-right-circle-line" />
                                </button>
                            </div>

                            <img
                                src={getPhoto(ano, card.src)}
                                alt={card.title}
