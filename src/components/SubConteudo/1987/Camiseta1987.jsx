  ...
  return (
    ...
    <>
      <div className={styles.cabecalho}>
        ...
        <h2 className={styles.titulo}>Desfile 1987, Ano 02 - Camiseta</h2>
      ...
      <div className={styles.container}>
        ...
        <section className={styles.card}>
          <div className={styles.imgCamisetaWrapper}>
            ...
            {/* <img src={CamisaFoto1} className={styles.imgCamiseta} alt="" /> */}
          </div>
        </section>
        ...
        <section className={styles.card}>
          <div className={styles.profileRow}>
            {Object.entries(Artistas["1987"]).map(([key, autor]) => (
